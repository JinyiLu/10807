...
# ./evaluate_object 2 yolo_Dec_7_tiny
...
# python code/scripts/eva/cal_ap.py results/yolo_Dec_7_tiny/plot_valid_30
...
./evaluate_object 2 yolo_Dec_7_big
python code/scripts/eva/cal_ap.py results/yolo_Dec_7_big/plot_valid_30
